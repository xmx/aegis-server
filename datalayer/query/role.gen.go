...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.Admin = field.NewBool(tableName, "admin")
	_role.Disabled = field.NewBool(tableName, "disabled")
	_role.Remark = field.NewString(tableName, "remark")
	_role.CreatedAt = field.NewTime(tableName, "updated_at")
	_role.UpdatedAt = field.NewTime(tableName, "created_at")
...
func (r *role) updateTableName(table string) *role {
	...
	r.Disabled = field.NewBool(table, "disabled")
