...
function ToastAction({
  ...
  return (
    <ToastPrimitive.Action
      ...
      render={render}
      className={cn("shrink-0 [&_svg]:transition-all [&_svg]:duration-300", className)}
      {...props}
    />
  )
}
...
function ToastClose({
  ...
  return (
    <ToastPrimitive.Close
      ...
      render={render}
      className={cn(
        "absolute top-1 right-1 z-10 shrink-0 text-muted-foreground/50 hover:text-foreground",
        className
      )}
      {...props}
    >
